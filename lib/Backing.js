...
function isBlobWriteInSubtree(keypath) {
  return function(blobWrite) {
    ...
    // We care about this write if the write path is below us (first condition), or
    // this write happened to a strict parent.
    // TODO more testing is needed to guarantee this won't cause superfluous notifications..
    return (theirPath.indexOf(keypath) === 0) || (keypath.indexOf(theirPath) === 0);
  };
}
